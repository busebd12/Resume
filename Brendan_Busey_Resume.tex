...
{\noindent {\fontsize{11}{8}\selectfont \textit{Most Knowledgeable}: Amazon Web Services (AWS), Bash scripting, Confluence, C++, HasiCorp Vault, Jira, Rundeck}}

\vspace{1mm}

{\noindent {\fontsize{11}{8}\selectfont \textit{Knowledgeable}: Ansible, Ansible Tower, Bitbucket, CentOS Linux, Git, GitHub, \LaTeX, Mac OS X, Vi}}
