...
{\noindent \textbf{\fontsize{10}{9}\selectfont TECHNICAL TOOLBOX}}
...
{\noindent {\fontsize{9}{8}\selectfont \textit{Most Knowledgeable}: Bash, C++, C++11, C++14, and C++ Standard Template Library}}

{\noindent {\fontsize{9}{8}\selectfont \textit{Knowledgeable}: C, CSS, HTML5}}

{\noindent {\fontsize{9}{8}\selectfont \textit{Familiar}: Angular, C\#, Java, jQuery, PHP}}

{\noindent {\fontsize{9}{8}\selectfont \textit{Other}: Ansible, Ansible Tower, Amazon Web Services (AWS), Bitbucket, Confluence, Eclipse IDE, Git, GitHub, Jenkins, Jira, Laravel, \LaTeX, Mac OS X, Oracle Access Manager (OAM), Oracle Entitlement Server (OES), Oracle Internet Directory (OID), Oracle Identity Federation (OIF), Oracle Identity Manager (OIM), Oracle Unified Directory (OUD), and Oracle Virtual Directory (OVD), Red Hat Linux, SonarQube, Twitter Bootstrap, Vi/Vim}}
