...
{\noindent {\fontsize{11}{8}\selectfont \textit{Knowledgeable}: Ansible, Ansible Tower, Bitbucket, Confluence, CentOS Linux, Git, GitHub, HasiCorp Vault, \LaTeX, Mac OS X, Jira, Rundeck, Vi}}

\vspace{1mm}

{\noindent {\fontsize{11}{8}\selectfont \textit{Familiar}: Eclipse IDE, Jenkins, Red Hat Linux, Twitter Bootstrap, Visual Studios}}
...
{\noindent $\diamond$ {\fontsize{12}{8}\selectfont Member of the Sovereign Cloud Product Engineering team responsible for enhancing, managing, and supporting applications and infrastructure in government cloud fabrics though secrets and certificate rotation, vulnerability management, and PowerShell automation.}}
