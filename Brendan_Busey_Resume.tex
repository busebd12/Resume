...
{\noindent {\fontsize{9}{8}\selectfont \textit{Other}: Ansible, Ansible Tower, Amazon Web Services (AWS), Bitbucket, Confluence, Eclipse IDE, Jira, Laravel, \LaTeX, Mac OS X, Oracle Access Manager (OAM), Oracle Entitlement Server (OES), Oracle Internet Directory (OID), Oracle Identity Federation (OIF), Oracle Identity Manager (OIM), Oracle Unified Directory (OUD), and Oracle Virtual Directory (OVD), Red Hat Linux, Twitter Bootstrap, Vi/Vim}}
